...
<phive xmlns="https://phar.io/phive">
    <phar name="llaville/sarif-php-sdk" version="^2.4" copy="false" />
</phive>
```
...
```shell
composer require bartlett/sarif-php-sdk ^2.4
```
...
```shell
git clone -b 2.4 https://github.com/llaville/sarif-php-sdk.git
```
