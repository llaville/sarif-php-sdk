...
<phive xmlns="https://phar.io/phive">
    <phar name="llaville/sarif-php-sdk" version="^2.3" copy="false" />
</phive>
```
...
```shell
composer require bartlett/sarif-php-sdk ^2.3
```
...
```shell
git clone -b 2.3 https://github.com/llaville/sarif-php-sdk.git
```
